...
describe('Tests for "Task 1"', function() {
 ...
 //15//       it('expect removing existent attribute not to throw', function() {
            function test() {
                var root = Object.create(domElement)
                    .init('td')
                    .addAttribute('rowsomething', 'has a value')
...
//18//      });
 ...
 //20       });
  ...
  //23      it('expect correct HTML when child is a string', function() {
      ...
      //24  it('expect correct HTML with nested domElements (one parent, one child)', function() {
            var child = Object.create(domElement)
                    .init('child'),
                parent = Object.create(domElement)
                    .init('parent')
  ...
  //29      it('expect string children to override parent\'s content', function() {
            var text = 'see me',
                parent = Object.create(domElement)
                    .init('parent')
                    .appendChild(text);
